        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div className="flex flex-col">
                <span className="text-emerald-500 font-bold text-lg">MCARE</span>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/jobs" className="hover:text-emerald-500 transition">All Jobs</Link></li>
              <li><Link to="/about" className="hover:text-emerald-500 transition">About Us</Link></li>
              <li><Link to="/contact" className="hover:text-emerald-500 transition">Contact Us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-emerald-500 transition">Hospital Jobs - Doctors</a></li>
              <li><a href="#" className="hover:text-emerald-500 transition">Hospital Management</a></li>
              <li><a href="#" className="hover:text-emerald-500 transition">Medical Colleges</a></li>
              <li><a href="#" className="hover:text-emerald-500 transition">Allied Health</a></li>
            </ul>
          </div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="pt-4">
                <div className="flex space-x-4">
                  <a href="#" className="hover:text-emerald-500 transition">Facebook</a>
