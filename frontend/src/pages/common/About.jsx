    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="py-14 md:py-20 px-4 bg-gradient-to-r from-cyan-500 to-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-4 md:mb-6">About MCARE</h1>
          <p className="text-base md:text-xl text-cyan-100">
            India's leading healthcare recruitment platform connecting medical professionals with top healthcare
            facilities
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-white rounded-xl p-6 md:p-8 shadow-lg text-center border border-gray-100">
              <div className="w-14 h-14 md:w-16 md:h-16 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-5 md:mb-6">
            ...
            <div className="bg-white rounded-xl p-6 md:p-8 shadow-lg text-center border border-gray-100">
              <div className="w-14 h-14 md:w-16 md:h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-5 md:mb-6">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            <div className="text-center">
              <div className="text-2xl md:text-4xl font-bold text-cyan-600 mb-1 md:mb-2">2,500+</div>
              <div className="text-xs md:text-base text-gray-600 font-medium">Active Jobs</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-4xl font-bold text-blue-600 mb-1 md:mb-2">850+</div>
            ...
            <div className="text-center">
              <div className="text-2xl md:text-4xl font-bold text-purple-600 mb-1 md:mb-2">150+</div>
      ...
      {/* CTA Section */}
      <section className="py-12 md:py-16 px-4 bg-gradient-to-r from-cyan-500 to-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-4xl font-bold text-white mb-4 md:mb-6">Ready to Join Us?</h2>
          <p className="text-base md:text-xl text-cyan-100 mb-6 md:mb-8">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/register"
              className="bg-white text-cyan-600 px-7 md:px-8 py-3 rounded-lg hover:bg-gray-100 font-medium inline-flex items-center justify-center transition shadow-lg text-sm md:text-base"
            >
              Get Started Today
            </Link>
            <Link
              to="/jobs"
              className="bg-transparent border-2 border-white text-white px-7 md:px-8 py-3 rounded-lg hover:bg-white hover:text-cyan-600 font-medium transition shadow-lg text-sm md:text-base"
            >
              Browse Jobs
            </Link>
          </div>
