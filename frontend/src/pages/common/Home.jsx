...
const DUMMY_JOBS = [
  ...
  // NURSING - 5 positions
  { id: 16, title: 'Senior Nurse – ICU', company: 'MCARE Hospitals', location: 'Hyderabad', city: 'Hyderabad', salary: '₹4,00,000 – ₹6,00,000', categoryKey: 'nursing', category: 'Nursing', specialization: 'BSc Nursing', description: 'Experienced ICU nurses for critical care. 12-hour shifts.', requirements: 'BSc/GNM Nursing, 3+ years ICU experience, BLS/ACLS', is_active: true },
  ...
  { id: 18, title: 'Operation Theatre Nurse', company: 'Fortis Healthcare', location: 'Delhi', city: 'Delhi', salary: '₹3,50,000 – ₹5,00,000', categoryKey: 'nursing', category: 'Nursing', specialization: 'BSc Nursing', description: 'OT nurse for surgical procedures assistance', requirements: 'BSc Nursing, OT experience 2+ years', is_active: true },
  { id: 19, title: 'Pediatric Nurse', company: 'Rainbow Children Hospital', location: 'Bangalore', city: 'Bangalore', salary: '₹3,50,000 – ₹5,50,000', categoryKey: 'nursing', category: 'Nursing', specialization: 'BSc Nursing', description: 'Specialized pediatric nursing care', requirements: 'BSc Nursing, pediatric experience preferred', is_active: true },
  { id: 20, title: 'Critical Care Nurse', company: 'Narayana Health', location: 'Bangalore', city: 'Bangalore', salary: '₹4,50,000 – ₹6,50,000', categoryKey: 'nursing', category: 'Nursing', specialization: 'BSc Nursing', description: 'CICU/NICU critical care nursing', requirements: 'BSc Nursing, critical care certification, 3+ years', is_active: true },
  
  // ALLIED HEALTH - 6 positions
  { id: 21, title: 'Medical Lab Technician', company: 'MCARE Diagnostics', location: 'Bangalore', city: 'Bangalore', salary: '₹3,00,000 – ₹4,50,000', categoryKey: 'allied', category: 'Pathology', specialization: 'BMLT', description: 'Lab technician for diagnostic centre', requirements: 'BMLT/DMLT, 2+ years experience', is_active: true },
  { id: 22, title: 'Physiotherapist', company: 'MCARE Rehab', location: 'Chennai', city: 'Chennai', salary: '₹3,50,000 – ₹5,00,000', categoryKey: 'allied', category: 'Rehabilitation', specialization: 'BPT', description: 'Rehabilitation physiotherapy specialist', requirements: 'BPT/MPT, 1+ year clinical experience', is_active: true },
  { id: 23, title: 'Radiographer', company: 'Apollo Imaging', location: 'Hyderabad', city: 'Hyderabad', salary: '₹2,80,000 – ₹4,00,000', categoryKey: 'allied', category: 'Radiology Tech', specialization: 'DMRT', description: 'X-Ray and CT scan technician', requirements: 'DMRT certification, 2+ years', is_active: true },
  { id: 24, title: 'Pharmacist', company: 'Fortis Pharmacy', location: 'Mumbai', city: 'Mumbai', salary: '₹3,00,000 – ₹4,50,000', categoryKey: 'allied', category: 'Pharmacy', specialization: 'B.Pharm', description: 'Hospital pharmacy operations and patient counseling', requirements: 'B.Pharm, registered pharmacist', is_active: true },
  { id: 25, title: 'Nutritionist', company: 'Max Healthcare', location: 'Delhi', city: 'Delhi', salary: '₹3,50,000 – ₹5,00,000', categoryKey: 'allied', category: 'Nutrition', specialization: 'MSc Nutrition', description: 'Clinical nutritionist for patient diet planning', requirements: 'MSc Nutrition/Dietetics, 2+ years', is_active: true },
  { id: 26, title: 'Occupational Therapist', company: 'Manipal Hospitals', location: 'Bangalore', city: 'Bangalore', salary: '₹3,20,000 – ₹4,80,000', categoryKey: 'allied', category: 'Therapy', specialization: 'BOT', description: 'Occupational therapy for rehabilitation', requirements: 'BOT/MOT, 1+ year experience', is_active: true },
  
  // MANAGEMENT - 4 positions
  { id: 27, title: 'Hospital Administrator', company: 'MCARE Management', location: 'Hyderabad', city: 'Hyderabad', salary: '₹8,00,000 – ₹12,00,000', categoryKey: 'management', category: 'Administration', specialization: 'MBA Healthcare', description: 'Oversee hospital operations and compliance', requirements: 'MBA Healthcare, 5+ years administration', is_active: true },
  { id: 28, title: 'Medical Billing Manager', company: 'Apollo Hospitals', location: 'Chennai', city: 'Chennai', salary: '₹6,00,000 – ₹9,00,000', categoryKey: 'management', category: 'Finance', specialization: 'MBA/B.Com', description: 'Manage medical billing and insurance claims', requirements: '5+ years in healthcare billing', is_active: true },
  { id: 29, title: 'Quality Manager', company: 'Fortis Healthcare', location: 'Bangalore', city: 'Bangalore', salary: '₹7,00,000 – ₹10,00,000', categoryKey: 'management', category: 'Quality Assurance', specialization: 'MBA Healthcare', description: 'NABH accreditation and quality standards', requirements: 'MBA, NABH auditor experience', is_active: true },
  { id: 30, title: 'HR Manager – Healthcare', company: 'Narayana Health', location: 'Bangalore', city: 'Bangalore', salary: '₹6,50,000 – ₹9,50,000', categoryKey: 'management', category: 'Human Resources', specialization: 'MBA HR', description: 'Healthcare recruitment and staff management', requirements: 'MBA HR, 4+ years in healthcare', is_active: true },
];
